    ...
    <div class="container">
      ...
      <div class="site-header__menu group">
        <nav class="main-navigation">
          ...
          <?php
          // Generic Dinamic Menu. We are not going to use it in this project
          /*  wp_nav_menu(array(
         ...
         */
          ...
          ?>
          <ul>
            <li <?php // wp_get_post_parent_id(get_the_ID()) =wp_get_post_parent_id(0)  0 means in here looking current page id ...
                if (is_page('about-us') || wp_get_post_parent_id(get_the_ID()) == 12)
